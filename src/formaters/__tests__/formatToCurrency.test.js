...
describe('Currency Formatter', () => {
  ...
  test('throws an error for invalid string parse', () => {
    expect(() => formatToCurrency('asdasdasd')).toThrow(Error)
    expect(() => formatToCurrency('')).toThrow(Error)
  })

  test('should return formatted number as currency string', () => {
    ...
    expect(formatToCurrency('123,4511', 4)).toBe('123,4511 €')
  })
})
